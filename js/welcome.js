...
$.ajax({
    ...
    data: {
        key: '34QBZ-MRGCQ-CBY5Z-4QKQK-PAEPQ-X3B6P',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.6654, 34.7580, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
